...
$sentencia = $bd->query("SELECT * FROM bebidasalcoholicas");
...
</svg></button> <span>Bebidas con alcohol</span>
...
<table id="customers">
    <?php
        foreach ($usuarios as $bebidasalcoholicas){
        ?>    
...
<tbody>
  ...
  <form action="bebidasalcoholicas.php" method="post">   
  <td>  
    <input type="hidden" name="producto" value="<?php echo $bebidasalcoholicas->bebidasalcohol?> "><?php echo $bebidasalcoholicas->bebidasalcohol?> 
  </td>
  <td>
    <input type="hidden" name="precio" value="<?php echo $bebidasalcoholicas->precio?>"><?php echo $bebidasalcoholicas->precio?>
    </td>  
    <td>
    <center><input type="number" name="cant" value="0" style="width:50px"></center>
    </td>
    <td>  
...
if(isset ($_REQUEST["btnAgregar"])) {
  ...
  $_SESSION["carrito"][$producto]["precio"]= $precio;
    ...
    echo "<script>alert(' $producto se agrego al pedido')</script>";
}
?>
